...
namespace Compilador_22023.AnalisisLexico
{
    public class AnalizadorLexico
    {
        ...
        {
            categoria = CategoriaGramatical.MÓDULO;
            FormarComponenteLexicoLiteral();
            continuarAnalisis = false;
        }
        ...
        {
            //Error decimal ni valido
            DevolverPuntero();
            falla = "Numero decimal no válido";
            causa = "Se recibió luedgo del separador decinaml el símbolo " + caracterActual;
            solucion = "Asegúrese que en la posición esperada se encuentre un digito, para formar un número decimal";
        ...
        private void ProcesarEstado18()
        {
            ...
            solucion = "Asegúrese que en la posición esperada se encuentre un simbol válido reconocido por el lengauje...";
